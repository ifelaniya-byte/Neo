...
class TranslatorInterfaceV8:
    ...
    def process_question(self, user_input):
        ...
        # =========================================================================
        # 4. STANDARD ROUTING (With Deep Persona Injection)
        # =========================================================================
        else:
            ...
            final_response = self.llm(final_formatted, max_tokens=250, temperature=0.4) if self.llm else "System offline."
...
def main():
    print("="*80)
    print("  INITIATING TRANSLATOR INTERFACE V8 (DEEP PERSONA INJECTION)")
    print("  The Diplomat now has a distinct, personalized intelligence and will not use generic AI disclaimers.")
    ...
    interface = TranslatorInterfaceV8()
