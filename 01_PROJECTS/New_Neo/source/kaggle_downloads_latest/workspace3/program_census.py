...
def snapshot():
    ...
    rec = {
        ...
        "honesty": (
            ...
            "This sandbox has no GPU/torch/transformers. Qwen2.5-0.5B files are complete "
            "on disk; offline load is unproven here. HF token absent. Kaggle token present "
            "(not printed). No adapter trained. No GPU run_report yet."
        ),
    }
    return rec
