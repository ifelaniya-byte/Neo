...
class ReflectiveReasoningLoop:
    ...
    def __init__(self, stationary: StationaryModel, actor: ExperimentalMergedModel, max_rounds: int = 2):
    ...
    def run(self, focus: str = None) -> Dict[str, Any]:
        ...
        final_verify = self.stationary.full_verification()
        return {
